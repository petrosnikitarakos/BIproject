...
try:
    ...
    query1 = "SELECT name,calculated_listings,total_listings FROM data_warehouse.facts_host ORDER BY calculated_listings DESC FETCH FIRST 10 ROWS ONLY"
    query2 = "SELECT name,calculated_listings,total_listings FROM data_warehouse.facts_host ORDER BY total_listings DESC FETCH FIRST 10 ROWS ONLY"
    ...
    plt.title("Which hosts are the busiest", fontsize="20")
